...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "manual_ip_hint": "Direct IP or [IPv6]:port",
        "status_ready": "Ready",
        "status_sent": "Sent",
        ...
        "status_enter_manual_ip": "Enter the target IP first",
        "status_invalid_manual_ip": "Enter a valid IP or [IPv6]:port",
        "status_enter_message": "Enter a message first",
        "status_nothing_to_copy": "No message available to copy",
        "status_ipv6_copied": "Copied local IPv6",
        "status_no_ipv6": "No shareable IPv6 address was found",
    ...
    "zh": {
        ...
        "manual_ip_hint": "手动输入 IP 或 [IPv6]:端口",
        "status_ready": "就绪",
        "status_sent": "已发送",
        "status_paired": "已配对",
        "status_connected": "已直连",
        "status_failed": "失败",
        "status_select_device": "请先选择设备",
        "status_enter_pair_code": "请输入目标配对码",
        "status_enter_manual_ip": "请先输入目标 IP",
        "status_invalid_manual_ip": "请输入有效的 IP 或 [IPv6]:端口",
        "status_enter_message": "请先输入消息",
        "status_nothing_to_copy": "当前没有可复制的消息",
        "status_ipv6_copied": "已复制本机 IPv6",
        "status_no_ipv6": "当前没有可直接分享的 IPv6 地址",
